...
<t:layout title="Infinity- Customer Registration">
  ...
  <form>
    ...
    <div id="field"><small>Press + to add category</small><br>
    <input autocomplete="off" class="input" id="field1" name="prof1" type="text" placeholder="Additional New Feature" data-items="8"/>
...
</select><p>Hold down Ctrl to select multiple options.</p>
</form>
</div>
