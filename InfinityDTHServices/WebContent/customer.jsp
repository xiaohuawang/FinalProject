...
<t:layout title="Infinity- Customer Registration">
  ...
  <form method="post" action="CreateCustomerServlet" id="form">
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="emailId" type="text" name="emailId" required>
    </div>
    
    
    <div class="form-group">
      <label for="inputlg">Password:</label>
      <input class="form-control" id="passwword" type="password" name="password" required>
    </div>
    
    <div class="form-group">
      <label for="inputlg">Confirm Password:</label>
      <input class="form-control" id="emailId" type="password" name="emailId" required>
    </div>
    
    <div class="form-group">
      <label for="inputlg">Phone Number:</label>
      <input class="form-control" id="phoneNumber" type="text" place name="phoneNumber" required>
    </div>
    <div class="form-group">
